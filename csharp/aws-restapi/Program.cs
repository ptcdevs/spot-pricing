...
app.MapGet("/syncpricing", async (HttpContext context) =>
{
    var connection = context.RequestServices.GetService<NpgsqlConnection>();
    var awsMultiClient = context.RequestServices.GetService<AwsMultiClient>();
